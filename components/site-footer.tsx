    ...
    <footer className="border-t bg-background mt-auto">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
                ...
                <div className="text-sm text-muted-foreground leading-relaxed space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제3조 약관 외 준칙</h4>
                    <p>운영자는 필요한 경우 별도로 운영정책을 공지 안내할 수 있으며, 본 약관과 운영정책이 중첩될 경우 운영정책이 우선 적용됩니다.</p>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제4조 이용계약 체결</h4>
                    <ul className="space-y-1 ml-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제5조 서비스 이용 신청</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 회원으로 등록하여 사이트를 이용하려는 이용자는 사이트에서 요청하는 제반정보(이용자ID, 비밀번호, 닉네임 등)를 제공해야 합니다.</li>
                      <li>② 타인의 정보를 도용하거나 허위의 정보를 등록하는 등 본인의 진정한 정보를 등록하지 않은 회원은 사이트 이용과 관련하여 아무런 권리를 주장할 수 없으며, 관계 법령에 따라 처벌받을 수 있습니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제6조 개인정보처리방침</h4>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제7조 운영자의 의무</h4>
                    <ul className="space-y-1 ml-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제8조 회원의 의무</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 회원은 본 약관에서 규정하는 사항과 운영자가 정한 제반 규정, 공지사항 및 운영정책 등 사이트가 공지하는 사항 및 관계 법령을 준수하여야 하며, 기타 사이트의 업무에 방해가 되는 행위, 사이트의 명예를 손상하는 행위를 해서는 안 됩니다.</li>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제9조 서비스 이용 시간</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 서비스 이용 시간은 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간을 원칙으로 합니다. 단, 사이트는 시스템 정기점검, 증설 및 교체를 위해 사이트가 정한 날이나 시간에 서비스를 일시중단 할 수 있으며 예정된 작업으로 인한 서비스 일시 중단은 사이트의 홈페이지에 사전에 공지하오니 수시로 참고하시길 바랍니다.</li>
                      ...
                      <li>③ 전항에 의한 서비스 중단의 경우 사이트는 사전에 공지사항 등을 통하여 회원에게 통지합니다. 단, 사이트가 통제할 수 없는 사유로 발생한 서비스의 중단에 대하여 사전공지가 불가능한 경우에는 사후공지로 대신합니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제10조 서비스 이용 해지</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 회원이 사이트와의 이용계약을 해지하고자 하는 경우에는 회원 본인이 온라인을 통하여 등록해지 신청을 하여야 합니다. 한편, 사이트 이용 해지와 별개로 사이트에 대한 이용계약 해지는 별도로 하셔야 합니다.</li>
                      <li>② 해지 신청과 동시에 사이트가 제공하는 사이트 관련 프로그램이 회원 관리 화면에서 자동적으로 삭제됨으로 운영자는 더 이상 해지신청자의 정보를 볼 수 없습니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제11조 서비스 이용 제한</h4>
                    <p className="mb-2">회원은 다음 각호에 해당하는 행위를 하여서는 아니 되며 해당 행위를 한 경우에 사이트는 회원의 서비스 이용 제한 및 적법한 조치를 할 수 있으며 이용계약을 해지하거나 기간을 정하여 서비스를 중지할 수 있습니다.</p>
                    <ul className="space-y-1 ml-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제12조 게시물의 관리</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 사이트의 게시물과 자료의 관리 및 운영의 책임은 운영자에게 있습니다. 운영자는 항상 불량 게시물 및 자료에 대하여 모니터링을 하여야 하며, 불량 게시물 및 자료를 발견하거나 신고를 받으면 해당 게시물 및 자료를 삭제하고 이를 등록한 회원에게 주의를 주어야 합니다. 한편, 이용회원이 올린 게시물에 대해서는 게시자 본인에게 책임이 있으니 회원 스스로 본 이용약관에서 위배되는 게시물은 게재해서는 안 됩니다.</li>
                      ...
                      <li>④ 사이트 및 운영자는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시 중단(전송중단)할 수 있으며, 게시중단 요청자와 게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련 기관의 결정 등이 이루어져 사이트에 접수된 경우 이에 따릅니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제13조 게시물의 보관</h4>
                    <p>사이트 운영자가 불가피한 사정으로 본 사이트를 중단하게 될 경우, 회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를 하기 위해 노력합니다.</p>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제14조 게시물에 대한 저작권</h4>
                    <ul className="space-y-1 ml-4">
                      ...
                      <li>③ 운영자는 회원이 게시하거나 등록하는 사이트 내의 내용물, 게시 내용에 대해 제12조 각호에 해당한다고 판단되는 경우 사전통지 없이 삭제하거나 이동 또는 등록 거부할 수 있습니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제15조 손해배상</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 본 사이트의 발생한 모든 민, 형법상 책임은 회원 본인에게 1차적으로 있습니다.</li>
                      <li>② 본 사이트로부터 회원이 받은 손해가 천재지변 등 불가항력적이거나 회원의 고의 또는 과실로 인하여 발생한 때에는 손해배상을 하지 않습니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제16조 면책</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 운영자는 회원이 사이트의 서비스 제공으로부터 기대되는 이익을 얻지 못하였거나 서비스 자료에 대한 취사선택 또는 이용으로 발생하는 손해 등에 대해서는 책임이 면제됩니다.</li>
                      <li>② 운영자는 본 사이트의 서비스 기반 및 타 통신업자가 제공하는 전기통신 서비스의 장애로 인한 경우에는 책임이 면제되며 본 사이트의 서비스 기반과 관련되어 발생한 손해에 대해서는 사이트의 이용약관에 준합니다.</li>
                      <li>③ 운영자는 회원이 저장, 게시 또는 전송한 자료와 관련하여 일체의 책임을 지지 않습니다.</li>
                      <li>④ 운영자는 회원의 귀책 사유로 인하여 서비스 이용의 장애가 발생한 경우에는 책임지지 아니합니다.</li>
                      <li>⑤ 운영자는 회원 상호 간 또는 회원과 제3자 상호 간, 기타 회원의 본 서비스 내외를 불문한 일체의 활동(데이터 전송, 기타 커뮤니티 활동 포함)에 대하여 책임을 지지 않습니다.</li>
                      ...
                      <li>⑨ 운영자는 서버 등 설비의 관리, 점검, 보수, 교체 과정 또는 소프트웨어의 운용 과정에서 고의 또는 고의에 준하는 중대한 과실 없이 발생할 수 있는 시스템의 장애, 제3자의 공격으로 인한 시스템의 장애, 국내외의 저명한 연구기관이나 보안 관련 업체에 의해 대응 방법이 개발되지 아니한 컴퓨터 바이러스 등의 유포나 기타 운영자가 통제할 수 없는 불가항력적 사유로 인한 회원의 손해에 대하여 책임지지 않습니다.</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">부칙</h4>
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
                ...
                <div className="text-sm text-muted-foreground leading-relaxed space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제1조 (개인정보의 처리목적)</h4>
                    ...
                    <ul className="space-y-2 ml-4">
                      <li>
                        ...
                        <p className="ml-2">회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.</p>
                      </li>
                      <li>
                        <strong>2. 재화 또는 서비스 제공</strong>
                        <p className="ml-2">물품 배송, 서비스 제공, 계약서 및 청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금 결제 및 정산, 채권추심 등을 목적으로 개인정보를 처리합니다.</p>
                      </li>
                      <li>
                        <strong>3. 고충 처리</strong>
                        <p className="ml-2">민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락․통지, 처리 결과 통보 등의 목적으로 개인정보를 처리합니다.</p>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제2조 (개인정보의 처리 및 보유기간)</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 회사는 법령에 따른 개인정보 보유, 이용 기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유, 이용 기간 내에서 개인정보를 처리, 보유합니다.</li>
                      <li>② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
                        <ul className="ml-4 mt-1 space-y-1">
                          <li>1. 홈페이지 회원 가입 및 관리 : 사업자/단체 홈페이지 탈퇴 시까지</li>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제3조(정보주체 및 법정대리인의 권리와 그 행사 방법)</h4>
                    <ul className="space-y-1 ml-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제6조(처리하는 개인정보 항목)</h4>
                    <p className="mb-2">회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
                    <ul className="space-y-2 ml-4">
                      <li>
                        <strong>1. 홈페이지 회원 가입 및 관리</strong>
                        <p className="ml-2">필수항목 : &lt; 아이디, 비밀번호, 닉네임 &gt;</p>
                        <p className="ml-2">선택항목 : &lt;예) - &gt;</p>
                      </li>
                      <li>
                        <strong>2. 재화 또는 서비스 제공</strong>
                        <p className="ml-2">필수항목 : &lt; 아이디, 비밀번호, 닉네임 &gt;</p>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제7조(개인정보의 파기)</h4>
                    <ul className="space-y-1 ml-4">
                      ...
                      <li>③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.
                        <ul className="ml-4 mt-1 space-y-1">
                          <li>
                            ...
                            <p className="ml-2">회사는 파기 사유가 발생한 개인정보를 선정하고, 회사의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.</p>
                          </li>
                          <li>
                            <strong>2. 파기 방법</strong>
                            <p className="ml-2">회사는 전자적 파일 형태로 기록․저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록․저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</p>
                          </li>
                        </ul>
                      </li>
                    </ul>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제8조(개인정보의 안전성 확보조치)</h4>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제9조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h4>
                    <ul className="space-y-1 ml-4">
                      ...
                      <li>④ 회사는 서비스 이용과정에서 사용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 수집・이용하고 있습니다.</li>
                    </ul>
                    <div className="mt-2 ml-4">
                      <p className="font-medium mb-1">▶ 웹 브라우저에서 쿠키 허용/차단</p>
                      <ul className="space-y-0.5 ml-4">
                        <li>- 크롬(Chrome) : 웹 브라우저 설정 &gt; 개인정보 보호 및 보안 &gt; 인터넷 사용기록 삭제</li>
                        <li>- 엣지(Edge) : 웹 브라우저 설정 &gt; 쿠키 및 사이트 권한 &gt; 쿠키 및 사이트 데이터 관리 및 삭제</li>
                      </ul>
                      <p className="font-medium mb-1 mt-2">▶ 모바일 브라우저에서 쿠키 허용/차단</p>
                      <ul className="space-y-0.5 ml-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제10조(개인정보 보호책임자)</h4>
                    <ul className="space-y-1 ml-4">
                      <li>① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</li>
                    </ul>
                    <div className="mt-2 ml-4">
                      <p className="font-medium mb-1">▶ 개인정보 보호책임자</p>
                      <ul className="space-y-0.5 ml-4">
                        <li>성명 : 박병수</li>
                        <li>직책 : 관리자</li>
                        <li>연락처 : w1thy0uplz@gmail.com</li>
                        <li>※ 개인정보 보호 담당부서로 연결됩니다.</li>
                      </ul>
                      <p className="font-medium mb-1 mt-2">▶ 개인정보 보호 담당부서</p>
                      <ul className="space-y-0.5 ml-4">
                        <li>부서명 : 관리자 팀</li>
                        <li>연락처 : w1thy0uplz@gmail.com</li>
                      </ul>
                    </div>
                    <p className="mt-2 ml-4">② 정보주체께서는 회사의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것입니다.</p>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제11조(개인정보 열람청구)</h4>
                    <p className="mb-2">정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 회사는 정보주체의 개인정보 열람 청구가 신속하게 처리되도록 노력하겠습니다.</p>
                    <div className="ml-4">
                      <p className="font-medium mb-1">▶ 개인정보 열람청구 접수․처리 부서</p>
                      <ul className="space-y-0.5 ml-4">
                        <li>부서명 : 관리자 팀</li>
                        <li>연락처 : w1thy0uplz@gmail.com</li>
                      </ul>
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">제12조(권익침해 구제 방법)</h4>
                    ...
                    <ul className="space-y-1 ml-4">
                      ...
                      <li>4. 경찰청 : (국번없이) 182 (ecrm.police.go.kr/minwon/main)</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">제13조(개인정보 처리방침 시행 및 변경)</h4>
                    <p>이 개인정보 처리방침은 2025. 12. 31. 부터 적용됩니다.</p>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
          ...
          <p className="text-xs">
            Copyright ⓒ TICKETFORUM All rights reserved.
          </p>
        </div>
      </div>
    </footer>
